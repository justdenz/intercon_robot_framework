...
describe("Test Home Target Modal", () => {
    test('Test if the Skin Care Target at Home Page Has modal and redirects to targets page', async () => {
        let exist = await page.evaluate(async () => {
            return await new Promise(async resolve => {
                ...
                let element = document.querySelector('#app > div:nth-child(6) > div > div:nth-child(2) > a > div > div')
                test = true
                element.click()
                await delay(500)
